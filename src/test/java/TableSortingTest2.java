...
public class TableSortingTest2 {
    WebDriver driver;
    By tableColumnsNames = By.xpath("//td//h3");
    ...
    public void whenComparingTwoHashMapsWithArrayValuesUsingEquals_thenFail() {
        ...
        columnIndex = columnDataMap.get("Country");

        List<String> beforeSort = new ArrayList<>(getColumnText(By.xpath(String.format(columnDataXPath, columnIndex))));
